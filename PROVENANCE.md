...
| Permissions / auto mode / sandbox patterns | Claude Code leak ports (Clawd-Code, pycc, Claw Code); public Anthropic auto-mode and sandboxing docs; anthropics/sandbox-runtime (Apache-2.0) as Linux bwrap reference | mixed / pattern-only | Pipeline order, two-stage reasoning-blind classifier, denial limits, bwrap isolation. No leaked TypeScript or classifier prompt files copied. | n/a (patterns) |
